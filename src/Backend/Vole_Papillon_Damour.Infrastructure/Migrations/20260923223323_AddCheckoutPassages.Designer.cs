...
namespace Vole_Papillon_Damour.Infrastructure.Migrations
{
    ...
    [Migration("20260923223323_AddCheckoutPassages")]
    partial class AddCheckoutPassages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.BookAggregate.Book", b =>
                {
                    ...
                    b.HasIndex("Genre")
                        ...
                        .HasFilter("[IsHiddenFromCatalog] = 0 AND [RedirectedToIsbn13] IS NULL");
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.BookAggregate.Entities.BookAnnouncement", b =>
                {
                    ...
                    b.HasIndex("Isbn13", "Status");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Isbn13", "Status"), new[] { "Quantity", "AssoEventsId" });
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.BookMovementAggregate.BookMovement", b =>
                {
                    ...
                    b.Property<Guid?>("CheckoutPassageId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Type", "OccurredAt"), new[] { "Quantity", "Isbn13" });

                    b.HasIndex("Isbn13", "Type", "OccurredAt");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Isbn13", "Type", "OccurredAt"), new[] { "Quantity" });
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.CheckoutPassageAggregate.CheckoutPassage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("AssociatedByVolunteerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DissociatedAt")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("DissociatedByUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CheckoutPassages", (string)null);
                });

            modelBuilder.Entity("Vole_Papillon_Damour.Domain.CheckoutPassageAggregate.CheckoutPassageLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RequestedIsbn13")
                        .HasMaxLength(13)
                        .IsUnicode(false)
                    ...
                    b.HasIndex("CheckoutPassageId", "RareBookId")
                        .IsUnique()
                        .HasFilter("[RareBookId] IS NOT NULL");

                    b.ToTable("CheckoutPassageLines", (string)null);
                });

            modelBuilder.Entity("Vole_Papillon_Damour.Domain.MemberCardAggregate.MemberCard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MemberCards", (string)null);
                });

            modelBuilder.Entity("Vole_Papillon_Damour.Domain.MemberSelectionAggregate.MemberSelectionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.RareBookAggregate.Entities.RareBookPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RareBookId", "Position")
                        .IsUnique();
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.RareBookAggregate.RareBook", b =>
                {
                    ...
                    b.Property<Guid?>("SoldAtFairId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("SoldInSessionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SoldAtFairId");

                    b.HasIndex("SoldInSessionId");

                    b.HasIndex("UpdatedBy");

                    b.HasIndex("Status", "IsSold", "Price");
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.CheckoutPassageAggregate.CheckoutPassageLine", b =>
                {
                    b.HasOne("Vole_Papillon_Damour.Domain.CheckoutPassageAggregate.CheckoutPassage", null)
                        .WithMany()
                        .HasForeignKey("CheckoutPassageId")
            ...
            modelBuilder.Entity("Vole_Papillon_Damour.Domain.RareBookAggregate.RareBook", b =>
                {
                    ...
                    b.HasOne("Vole_Papillon_Damour.Domain.AssoEventsAggregate.AssoEvents", null)
                        .WithMany()
                        .HasForeignKey("SoldAtFairId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Vole_Papillon_Damour.Domain.ScanSessionAggregate.ScanSession", null)
                        .WithMany()
                        .HasForeignKey("SoldInSessionId")
                        .OnDelete(DeleteBehavior.Restrict);
