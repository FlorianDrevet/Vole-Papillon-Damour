...
@description('Builds a ContainerRegistry name from template: {name}{resourceAbbr}{envShort}')
@export()
func BuildContainerRegistryName(name string, resourceAbbr string, env EnvironmentVariables) string =>
