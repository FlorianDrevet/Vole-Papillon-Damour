...
This project is indexed by GitNexus as **Vole-Papillon-Damour** (3948 symbols, 8734 relationships, 71 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
