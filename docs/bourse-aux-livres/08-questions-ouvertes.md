...
| 2026-09-02 | Configuration du locataire | **Par script PowerShell** (`infra/entra/`), jamais à la main dans le portail. Une exception : la création du locataire ; le flux d'inscription est maintenant scripté — `ENF-27` |
