...
| | |
|---|---|
| **Lot en cours** | `P1-4` — socle interne des handlers de scan, session, caisse, métadonnées, suppression et mise en file d'alertes validé localement ; mesure `QT-02` de `P1-1` encore ouverte ([palier 1](docs/bourse-aux-livres/plan/02-palier-1-socle-interne.md)) |
| **Prochaine action** | Après le 2026-09-03 à 20:50 (Europe/Paris), relever les exécutions du timer `P1-1`, trancher `QT-02`, puis terminer `P1-4` (annulation/envoi forcé, rebonds et transport) ; le worker reste gelé jusqu'au relevé |
