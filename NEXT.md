...
| **Dernière machine** | Windows — `C:\Users\flori\RiderProjects\Vole-Papillon-Damour-fix-account-registration-button` |
| **Dernière mise à jour** | 2026-09-10 — retour OAuth Catalog corrigé, 122 tests et build SSR/navigateur passants, aucun déploiement |
| **Branche** | `fix/account-registration-button` — worktree dédié, synchronisée avec `origin/main`, PR à ouvrir |
