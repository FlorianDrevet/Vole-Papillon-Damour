...
| **Dernière mise à jour** | 2026-09-09 — galerie familiale et textes éditoriaux intégrés, PR à ouvrir, aucun déploiement |
| **Branche** | `feat/media-gallery-and-content` — worktree dédié, synchronisée avec `origin/main`, à pousser puis proposer en PR |
