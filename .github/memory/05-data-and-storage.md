...
- Migrations `20260903173750_AddBookExchangeCore`, `20260903175445_AddClientGestureIdToBookAnnouncements`, `20260903181307_AddSaleReversalLink`, `20260903185500_AddBookWatchlistsAndAlerts`, `20260903192839_AddEmailBounceEventLedger`, `20260903211547_AddWatchlistUpdatedAt`, and `20260903230825_AddCancelledBookFair` create the Books foundation, complete the announcement gesture trace, add a filtered-unique self-link for movement inverses, add the watchlist/alert-history tables with target and cascade constraints, add the provider-event ledger with its unique provider identity, persist a UTC `UpdatedAt` watermark on watchlists (backfilled from `CreatedAt`), and persist cancelled-fair state. They were applied to DEV Azure SQL by Books runtime run `33908408641`; the new `20260904193041_AddDeadStockQueryIndex` migration adds `Isbn13 + Type + OccurredAt` for the administration dead-stock read and awaits this branch's rollout.
