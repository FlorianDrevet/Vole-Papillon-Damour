...
mockup treatment (cover/status/content/footer), while rare, search, work and detail cards
keep the default variant. The existing cover placeholder remains the fallback whenever a
book has no image, and the home never invents genre counts that the API does not provide.
